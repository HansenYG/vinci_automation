...
| 2.3 | Open the **Schedule** page and click that lesson. | The lesson status shows **Cancelled** (grey), and no tutor is assigned anymore. | ☐ Pass ☐ Fail |
| 2.4 | Ask another tutor (or check with one) whether they received a new WhatsApp offer for that lesson. | Other suitable tutors get a fresh offer automatically (the system looks for a replacement). | ☐ Pass ☐ Fail |
| 2.5 | Have another tutor reply **"Accept"** to that offer. | The lesson status changes to **Has Acceptance** — it is no longer Cancelled. | ☐ Pass ☐ Fail |
